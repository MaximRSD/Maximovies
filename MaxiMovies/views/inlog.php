<?php
session_start();
include("../controller/MoviesClasses.php");
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="inlogclass">
                            <form class="white" method="POST" enctype="multipart/form-data">
                                ...
                                <input class="opslaanbutton d-inline" type="submit" value="Login" name="btnSubmit">
                                <a href="register.php">
                                    <p class="white float-right">Nog geen accie?</p>
                                </a>
                            </form>
                            <?php
                            ...
                            if (isset($_POST['btnSubmit'])) {
                                ...
                                $mc->loginUser($username, $wachtwoord);
                            }
                            ?>
                        </div>
                    </div>
